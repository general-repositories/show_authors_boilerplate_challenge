...
class Show_Authors {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Show_Authors_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 * - Show_Authors_i18n. Defines internationalization functionality.
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-show-authors-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-show-authors-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-show-authors-admin.php';
	 ...
	 *
	 * Uses the Show_Authors_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Show_Authors_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Show_Authors_Admin( $this->get_plugin_name(), $this->get_version() );
